        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-8 w-full">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-gradient-primary p-6 md:p-10 rounded-2xl shadow-[0_15px_40px_rgb(46,125,50,0.2)] text-white relative overflow-hidden group animate-fade-in-up delay-[400ms]">
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold mb-6 md:mb-10 relative z-10 text-white drop-shadow-md">Get In Touch</h2>
              <div className="space-y-6 md:space-y-10 relative z-10">
                
                {/* Location */}
                <div className="flex items-start gap-4 md:gap-5 group/item cursor-default">
                  <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-2.5 md:p-4 rounded-full text-white shrink-0 group-hover/item:scale-110 group-hover/item:bg-[#EA4335] group-hover/item:border-[#EA4335] group-hover/item:text-white transition-all duration-300 shadow-lg flex items-center justify-center">
                ...
                <div className="flex items-center gap-4 md:gap-5 group/item cursor-default">
                  <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-2.5 md:p-4 rounded-full text-white shrink-0 group-hover/item:scale-110 group-hover/item:bg-[#007AFF] group-hover/item:border-[#007AFF] group-hover/item:text-white transition-all duration-300 shadow-lg flex items-center justify-center">
                ...
                {/* Email */}
                <div className="flex items-center gap-4 md:gap-5 group/item cursor-default">
                  <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-2.5 md:p-4 rounded-full text-white shrink-0 group-hover/item:scale-110 group-hover/item:bg-[#F59E0B] group-hover/item:border-[#F59E0B] group-hover/item:text-white transition-all duration-300 shadow-lg flex items-center justify-center">
                ...
                {/* WhatsApp */}
                <div className="flex items-center gap-4 md:gap-5 group/item cursor-default">
                  <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-2.5 md:p-4 rounded-full text-white shrink-0 group-hover/item:scale-110 group-hover/item:bg-[#25D366] group-hover/item:border-[#25D366] group-hover/item:text-white transition-all duration-300 shadow-lg flex items-center justify-center">
